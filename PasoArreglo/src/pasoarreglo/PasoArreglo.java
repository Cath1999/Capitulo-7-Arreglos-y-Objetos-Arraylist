...
// Paso de arreglos y elementos individuales de un arreglo a los métodos.
 ...
 System.out.println(
 “Efectos de pasar una referencia a un arreglo completo:%n” +“Los valores del arreglo original son:%n”);
 ...
 System.out.printf( “%n%nEfectos de pasar el valor de un elemento del arreglo:%n” + “arreglo[3] antes de modificarElemento: %d%n”, arreglo[3]);
